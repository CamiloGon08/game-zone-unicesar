...
Implementation of Taller 1, Programación de Computadores III (SS462), Ingeniería de Sistemas, Universidad Popular del Cesar.
...
Data files under `data/` are created and updated automatically. The file `data/sellers.txt` is preloaded with 3 sellers.
